...
3. Generate the PNG or PDF handwriting sheets.
4. Either print and fill the sheets in black ink, or open the PNG files in a painting app of your choice and draw digitally.
5. Scan or photograph printed sheets as PNG or JPEG files; digitally completed PNGs can be imported directly.
6. Import all completed pages and review missing glyphs or extraction warnings.
7. Refine outline detail and glyph size, then adjust spacing and kerning.
8. Build the font and test it in the live preview.
9. Open the Export view to locate the generated desktop and web font files.
